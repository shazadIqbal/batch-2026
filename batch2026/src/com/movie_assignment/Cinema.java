...
//        LocalDateTime dateTime = LocalDateTime.of(2026, 8, 26, 18, 0);
//
...
//    }
//
//    // Single definition of getShowByMovieName
//    public Show getShowByMovieName(String movieName) {
//        for (Show show : this.showList) {
//            if (show.getMovie() != null && movieName.equalsIgnoreCase(show.getMovie().getName())) {
//                return show;
//            }
//        }
//        return null;
...
//        } else {
//            System.out.println("Show not found for movie: " + movieName);
//        }
//    }
//
